          ...
          if (exam.subjectId === subject.id) {
            ...
            if (user.role === "professor" || user.role === "admin") {
              ...
              examUserList.forEach((userExam: any) => {
                ...
                const userIdForThisExam = userExam.id || userExam.userId || userExam.documentId;
                ...
                filteredResults.push({
                  ...
                  totalQuestions,
                  percentage: totalQuestions > 0 ? (userExam.score / totalQuestions) * 100 : 0,
      ...
      <Card className="w-full">
        <CardHeader className="pb-2">
          <div className="flex items-center gap-2">
            ...
            <CardTitle className="text-xl">{subject?.name} Exam Results</CardTitle>
          </div>
                    ...
                    >
                      ...
                      <TableCell className={getScoreColor(percentage)}>
                        <div className="flex items-center gap-2">
                          ...
                          {percentage >= 80 && <Trophy className="h-4 w-4 text-amber-500" />}
                        </div>
                      </TableCell>
